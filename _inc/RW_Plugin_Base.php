...
if ( ! class_exists( 'RW_Plugin_Base' ) ):
	class RW_Plugin_Base {
		 ...
		 * @param bool $has_settings_page Whether we need to show a settings page
		...
		function rw_render_save_setting_box() {
			...
			<table class="form-table">
				<tr>
					...
					<td>
						<input id="submit" class="button " type="submit" value="<?php esc_attr_e( 'Reset To Defaults', $this->_text_domain );?>" name="reset">
					</td>
				</tr>
			</table>
		<?php
		 ...
		 * @param int $post_id Post Id to add the fields to
		 * @param array$custom_post_meta Array of custom fields to process. The key is the name of the custom field
